...
<script type='text/javascript'>
	...
	function registration() {
		...
		if (confirm('등록 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/company/registration",
			    data : formData,
			    processData: false,
			    contentType: false,
...
<div class="page-nation container">
    ...
    <a href="javascript:void(0);">기업 등록</a>
</div>
<!--본문시작-->
...
<!--페이지 타이틀-->				
		<div class="page-header">
			<h3 class="page-title text-primary-d2 text-120">기업 등록</h3>
			...
			<form name="frm" id="frm">
                  ...
                  <table class="job_write">
                  	...
                  	<div class="upload_btn">
                  		<button type="button" class="blue_btn" onclick='registration();'>등록</button>
                  	</div>
          	</form>
        </div>
	</div>
