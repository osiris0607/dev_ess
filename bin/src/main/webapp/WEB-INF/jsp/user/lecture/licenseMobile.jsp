...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/user/api/lecture/license/search/all' />");
	        ...
	        <ul class="accodion" id="ul_body">
	          <li>
	            ...
	            <div class="accodion-content item-hide">
	              <p class="licenseItem"><a href="">신재생에너지발전설비기능사(ESS)</a></p>
	              <p class="licenseItem"><a href="">신재생에너지발전설비기사(ESS)</a></p>
	              <p class="licenseItem"><a href="">신재생에너지발전설비산업기사(ESS)</a></p>
	            </div>
	          </li>
	          <li>
